                    ...
                    <form action="{{ route('mahasiswa.store') }}" method="POST" class="p-4 md:p-5">
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="grid-cols-2">
                                ...
                                <select id="tahun_ajaran_id" name="tahun_ajaran_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <tbody>
                        @foreach($mahasiswa as $mhs)
                            <tr class="hover:bg-gray-50">
                                <td class="border border-gray-300 px-4 py-2 text-center">{{ $loop->iteration + ($mahasiswa->currentPage() - 1) * $mahasiswa->perPage() }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $mhs->nama_mahasiswa }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $mhs->nim }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $mhs->tempat_lahir }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $mhs->tanggal_lahir }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $mhs->jenis_kelamin }}</td>
                                ...
                                <td class="border border-gray-300 px-4 py-2">
                                    <div class="flex justify-center space-x-2">
                                        <button data-modal-target="editModal-{{ $mhs->id }}" data-modal-toggle="editModal-{{ $mhs->id }}" class="flex items-center justify-center w-full sm:w-20 md:w-20 px-3 py-1 bg-yellow-400 text-white rounded-lg hover:bg-yellow-600 transition duration-200 mb-2 sm:mb-0">Edit</button>
                                        <!-- Modal Edit -->
                                        <div id="editModal-{{ $mhs->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-full max-h-full bg-black bg-opacity-45">
                                            <div class="relative p-4 w-full max-w-3xl max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow-sm">
                                                    <!-- Modal header -->
                                                    ...
                                                    <form action="{{ route('mahasiswa.update', $mhs->id) }}" method="POST" class="p-4 md:p-5">
                                                        ...
                                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                                            ...
                                                            <div class="grid-cols-2">
                                                                <label for="edit_tahun_ajaran" class="block mb-2 text-sm font-medium text-gray-900">Program Studi</label>
                                                ...
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <div class="relative bg-white rounded-lg shadow-sm">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah anda yakin ingin menghapus Data Mahasiswa ini?</h3>
...
{{-- <script>
    function openEditModal(id, namaMahasiswa, nim, tempatLahir, tanggalLahir, jenisKelamin, prodiId, tahunAjaranId) {
        document.getElementById('edit_nama_mahasiswa').value = namaMahasiswa;
        ...
        document.querySelector(`input[name="jenis_kelamin"][value="${jenisKelamin}"]`).checked = true;
        document.getElementById('edit_program_studi').value = prodiId;
        document.getElementById('edit_tahun_ajaran').value = tahunAjaranId;
