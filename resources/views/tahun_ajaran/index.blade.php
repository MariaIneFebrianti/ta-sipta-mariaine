                ...
                <table class="mb-4 table-auto w-full border-collapse border border-gray-200">
                    <thead class="bg-gray-100">
                        <tr class="text-center">
                            ...
                            <th class="w-6/12 border border-gray-300 px-4 py-2">Tahun Ajaran</th>
                            <th class="w-5/12 border border-gray-300 px-4 py-2">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border border-gray-300 px-4 py-2 text-center">
                                    <div class="flex justify-center space-x-2">W
                                        <button data-modal-target="editModal-{{ $tahun->id }}" data-modal-toggle="editModal-{{ $tahun->id }}" class="flex items-center justify-center w-full sm:w-20 md:w-20 px-3 py-1 bg-yellow-400 text-white rounded-lg hover:bg-yellow-600 transition duration-200 mb-2 sm:mb-0">Edit</button>
                                        <!-- Modal Edit -->
                                        ...
                                        <form id="delete-form-{{ $tahun->id }}" action="{{ route('tahun_ajaran.destroy', $tahun->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="flex w-full sm:w-20 md:w-20 px-3 py-1 text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button" onclick="openDeleteModal('{{ $tahun->id }}')">
                                                Hapus
                                            </button>
                                                ...
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <div class="relative bg-white rounded-lg shadow-sm">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah anda yakin ingin menghapus Data Tahun Ajaran ini?</h3>
