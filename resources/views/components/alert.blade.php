...
<div id="{{ $id }}" class="flex items-center justify-between p-4 mb-4 text-sm {{ $style['text'] }} rounded-lg {{ $style['bg'] }} dark:bg-gray-800 {{ $style['dark'] }}" role="alert">
  ...
  <button type="button"
    class="ml-4 -my-1.5 text-xl bg-transparent {{ $style['text'] }} rounded-lg focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 hover:text-opacity-70"
