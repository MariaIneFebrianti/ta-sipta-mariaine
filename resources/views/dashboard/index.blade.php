...
<div class="p-4 sm:ml-64 mt-6">
    <div class="col-span-12 space-y-6 xl:col-span-7">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-4 md:gap-6">            <!-- Metric Item Start -->
            {{-- ini yang kanan kiri --}}
            <!-- Jumlah User -->
            {{-- <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                <div class="flex flex-col md:flex-row-reverse items-center md:items-start justify-between">
                    <!-- Icon -->
                    <div class="mb-4 md:mb-0 flex h-12 w-12 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
