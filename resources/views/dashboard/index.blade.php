...
<div class="p-4 sm:ml-64 mt-6">
    <div class="col-span-12 space-y-6 xl:col-span-7">
        <div class="px-10 py-8 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        @if ( auth()->user()->role === 'Dosen' && auth()->user()->dosen && auth()->user()->dosen->jabatan === 'Koordinator Program Studi' || auth()->user()->role === 'Dosen')
            <div class="px-10 py-8 rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-4 md:gap-6">
                    <!-- Jumlah User -->
                    <div class="rounded-2xl shadow-lg border border-gray-100 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6 ">
                        ...
                        @csrf
                            {{-- <div class="mb-6 max-w-full">
                                <label class="block mb-2 text-sm font-medium text-gray-700">
                                    Unggah Tanda Tangan (JPG/JPEG/PNG)
                                </label>

                                <div class="flex flex-nowrap items-center gap-2">
                                    <input type="file" name="ttd_mahasiswa" accept=".jpg,.jpeg,.png"
                                        class="shrink w-[220px] text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 px-2 py-1"
                                        required>
                                ...
                                @if ($mahasiswa->ttd_mahasiswa)
                                    ...
                                    <img src="{{ asset('storage/' . $mahasiswa->ttd_mahasiswa) }}" alt="Tanda Tangan"
                                        class="mt-1 w-32 h-auto rounded border">
                                @endif
                            </div> --}}
                        <div class="w-full lg:w-1/2">
                            <label class="block mb-2 text-sm font-medium text-gray-700">Unggah Tanda Tangan (JPG/JPEG/PNG)</label>
